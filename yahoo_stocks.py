...
df.to_csv('intermediate.csv', index = True)
...
for security in securities2:
   df2[security] = ((yf.Ticker(security).history(start='2021-01-28', end = '2021-08-17').Close\
       - yf.Ticker(security).history(start='2021-01-28', end = '2021-08-17').Open)\
        /yf.Ticker(security).history(start='2021-01-28', end = '2021-08-17').Close) * 100

#modify date column and set back to index
df2.to_csv('intermediate', index = True)
